...
- La stessa conversione gira da un'API REST, una CLI senza dipendenze che sceglie la conversione dall'estensione del file, una GitHub Action e un server MCP
